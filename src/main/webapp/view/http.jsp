	...
	$(document).ready(function() {
		...
		$('#delete').click(function() {
			...
			$.ajax({
				...
				success : function(data) {
					if (data.isSuc) {
						alert('Deleted request tempaltes');
					} else {
						if(data.msg){
							alert(data.msg);				
						}else{
...
<body>
	<jsp:include page="nav.jsp?index=http"></jsp:include>
    <h1>HTTP Test Client</h1>
    <div class="bs-example">
        ...
        <form class="form-horizontal" onsubmit='return sendSoap()'>
            ...
            <div class="form-group">
                <label class="control-label col-xs-3" for="input">HTTP Input</label>
                <div class="col-xs-9">
			...
			<div class="form-group">
				...
				<div class="dropdown col-xs-9">
					<button class="btn btn-default dropdown-toggle" type="button"
						id="dropdownMenu1" data-toggle="dropdown">HTTP Templates<span class="caret"></span>
					</button>
